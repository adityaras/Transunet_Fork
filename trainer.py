...
#                 print(loss_dice)
            ...
            if args.patch_mse_loss:
                label_batch = label_batch.squeeze()
                loss_patch_mse = patch_mse_loss.loss(outputs, label_batch)
...
#                 writer.add_image('train/GroundTruth', labs, iter_num)
            if args.patch_mse_loss and args.dice_flag:
                print('iteration %d : loss : %f, loss_ce: %f, weighted_loss_dice : %f, weighted_loss_patch_mse: %f' % (iter_num, loss.item(), loss_ce.item(), str(args.alpha_coeff* loss_dice.item()), str(args.gamma_coeff * loss_patch_mse.item)))
            elif args.patch_mse_loss:
                print('iteration %d : loss : %f, loss_ce: %f, weighted_loss_patch_mse: %f' % (iter_num, loss.item(), loss_ce.item(), str(args.gamma_coeff * loss_patch_mse.item)))
            elif args.dice_flag:
                print('iteration %d : loss : %f, loss_ce: %f, weighted_loss_dice: %f' % (iter_num, loss.item(), loss_ce.item(), str(args.alpha_coeff* loss_dice.item())))
            else:
